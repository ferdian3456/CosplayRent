...
func (repository *ReviewRepository) FindUserReview(ctx context.Context, tx *sql.Tx, uuid string) ([]review.OwnReviewResponse, error) {
...
func (repository *ReviewRepository) Update(ctx context.Context, tx *sql.Tx, review review.ReviewUpdateRequest, uuid string) {
...
func (repository *ReviewRepository) FindUserReviewByReviewID(ctx context.Context, tx *sql.Tx, uuid string, reviewid int) (review.OwnReviewByReviewID, error) {

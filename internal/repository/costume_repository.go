...
func (repository *CostumeRepository) FindByName(ctx context.Context, tx *sql.Tx, name string) ([]costume.CostumeResponse, error) {
...
func (repository *CostumeRepository) Update(ctx context.Context, tx *sql.Tx, costume costume.CostumeUpdateRequest, uuid string) {
...
func (repository *CostumeRepository) FindByUserUUID(ctx context.Context, tx *sql.Tx, userUUID string) ([]costume.CostumeResponse, error) {
...
func (repository *CostumeRepository) FindSellerCostume(ctx context.Context, tx *sql.Tx, uuid string) ([]costume.CostumeResponse, error) {
...
func (repository *CostumeRepository) GetSellerIdFindByCostumeID(ctx context.Context, tx *sql.Tx, userUUID string, costumeid int) (string, error) {
